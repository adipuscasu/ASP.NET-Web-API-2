...
IF (NOT EXISTS (SELECT TOP 1 1
                 FROM INFORMATION_SCHEMA.TABLES 
                 WHERE TABLE_SCHEMA = 'dbo' 
                 AND  TABLE_NAME = 'BOT_EMPLOYEE'))
BEGIN
    
CREATE TABLE BOT_EMPLOYEE(    
    BOT_EMPLOYEE_ID int IDENTITY(1,1) NOT NULL,    
    BOT_EMPLOYEE_FIRSTNAME nvarchar(100) NULL,
    BOT_EMPLOYEE_LASTNAME nvarchar(100) NULL,
    BOT_EMPLOYEE_SALARY INT NULL)
 
END
GO

IF (NOT EXISTS (SELECT TOP 1 1 FROM BOT_EMPLOYEE))
BEGIN
	INSERT INTO BOT_EMPLOYEE(
	BOT_EMPLOYEE_FIRSTNAME
	, BOT_EMPLOYEE_LASTNAME
	, BOT_EMPLOYEE_SALARY)
	VALUES
	('MARK', 'HASTINGS', 60000)
	, ('STEVE', 'POUND', 45000)
	, ('BEN', 'HOSKINS', 70000)
	, ('Philip', 'Hastings', 45000)
	, ('Mary', 'Lambeth', 30000)
	, ('Valary', 'Vikings', 35000)
	, ('John', 'Starmore', 80000)
END
GO