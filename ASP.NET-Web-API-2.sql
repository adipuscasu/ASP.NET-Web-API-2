...
CREATE TABLE GOT_USER(    
    ...
    GOT_USER_ACTIVE nvarchar(50) NOT NULL,
    ...
    GOT_USER_PHONE_NUMBER_CONFIRMED tinyint NOT NULL,
    GOT_USER_TWO_FACTOR_ENABLED tinyint NOT NULL,
    GOT_USER_LOCKOUT_END_DATE datetime NULL,
    GOT_USER_LOCKOUT_ENABLED tinyint NOT NULL,
